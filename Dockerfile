...
RUN test -r /contacts-1.5.2.tar.gz && mv -f /contacts-1.5.2.tar.gz contacts.tar.gz &&   echo "4c2387ce249a9700b5d5b65570f35bb36ecc456ac01bbf66e74defa824169dfd contacts.tar.gz" | sha256sum -c - &&   mkdir -p /var/www/owncloud/apps/contacts &&   tar xfz contacts.tar.gz -C /var/www/owncloud/apps/contacts --strip-components 1 &&   rm -f contacts.tar.gz
...
LABEL org.label-schema.build-date=2017-11-10T12:24:31Z
LABEL org.label-schema.vcs-ref=c02699d
